...
public class HeadingAdapter extends RecyclerView.Adapter<HeadingAdapter.HeadingViewHolder> {
    ...
    public void onBindViewHolder(HeadingViewHolder headingViewHolder, int position) {
        ...
        headingViewHolder.tariffHeadingIcon.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        headingViewHolder.tariffHeadingDescription.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
