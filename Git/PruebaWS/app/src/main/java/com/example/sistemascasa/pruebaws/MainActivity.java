package com.example.sistemascasa.pruebaws;
...
public class MainActivity  extends Activity {
    ...
    private class TareaWSConsulta extends AsyncTask<String,Integer,String> {
        ...
        protected String doInBackground(String... params) {
            final String NAMESPACE = "http://10.40.68.153:8080/serverWS/";
            final String URL = "http://10.40.68.153:8080/serverWS/services/HolaMundo?wsdl";
            final String SOAP_ACTION = "http://10.40.68.153:8080/serverWS/services/";
            final String METHOD_NAME = "getFraction";
            //boolean resul = true;
            ...
            // Set Value
            sayHelloPI.setValue("01022902");

            //WsStub ws = new WsStub("http://10.40.68.153:8080/serverWS/services/HolaMundo?wsdl");
    ...
    private class TareaWSInsercion1 extends AsyncTask<String,Integer,Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            request.addProperty("nombre", "sara");
            request.addProperty("telefono", "53583452");
    ...
    private class TareaWSInsercion2 extends AsyncTask<String,Integer,Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            Cliente cli = new Cliente();
            cli.nombre = "sara";
            cli.telefono = Integer.parseInt("53");
